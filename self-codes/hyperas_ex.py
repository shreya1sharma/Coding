...
# -*- coding: utf-8 -*-
"""
Created on Sat Nov 11 00:08:18 2017
...
#wrap the data and the model into functions and then run a minimizer. Specify the scoring function to beused to eavluate the model.
def data():
    nb_classes=10
